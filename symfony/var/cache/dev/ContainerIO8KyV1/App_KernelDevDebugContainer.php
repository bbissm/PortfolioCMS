...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\AttachmentCrudController' => 'getAttachmentCrudControllerService',
            ...
            'App\\Controller\\HobbyController' => 'getHobbyControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Doc575U8OG', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NjFX-x5awi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($this->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'vich_uploader.listener.clean.event_attachments' => ['privates', 'vich_uploader.listener.clean.event_attachments', 'getVichUploader_Listener_Clean_EventAttachmentsService', true],
            'vich_uploader.listener.clean.member_attachments' => ['privates', 'vich_uploader.listener.clean.member_attachments', 'getVichUploader_Listener_Clean_MemberAttachmentsService', true],
            'vich_uploader.listener.remove.event_attachments' => ['privates', 'vich_uploader.listener.remove.event_attachments', 'getVichUploader_Listener_Remove_EventAttachmentsService', true],
            'vich_uploader.listener.remove.member_attachments' => ['privates', 'vich_uploader.listener.remove.member_attachments', 'getVichUploader_Listener_Remove_MemberAttachmentsService', true],
            'vich_uploader.listener.upload.event_attachments' => ['privates', 'vich_uploader.listener.upload.event_attachments', 'getVichUploader_Listener_Upload_EventAttachmentsService', true],
            'vich_uploader.listener.upload.member_attachments' => ['privates', 'vich_uploader.listener.upload.member_attachments', 'getVichUploader_Listener_Upload_MemberAttachmentsService', true],
        ], [
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber' => '?',
            'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber' => '?',
            'vich_uploader.listener.clean.event_attachments' => '?',
            'vich_uploader.listener.clean.member_attachments' => '?',
            'vich_uploader.listener.remove.event_attachments' => '?',
            'vich_uploader.listener.remove.member_attachments' => '?',
            'vich_uploader.listener.upload.event_attachments' => '?',
            'vich_uploader.listener.upload.member_attachments' => '?',
        ]), [0 => 'vich_uploader.listener.clean.member_attachments', 1 => 'vich_uploader.listener.clean.event_attachments', 2 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 3 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 4 => 'vich_uploader.listener.remove.member_attachments', 5 => 'vich_uploader.listener.upload.member_attachments', 6 => 'vich_uploader.listener.remove.event_attachments', 7 => 'vich_uploader.listener.upload.event_attachments', 8 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]), []);
    }
    ...
    {
        return $this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\CrudControllerRegistry'] = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry($this->getEnv('APP_SECRET'), [0 => 'App\\Controller\\Admin\\AttachmentCrudController', 1 => 'App\\Controller\\Admin\\EventCrudController', 2 => 'App\\Controller\\Admin\\LocationCrudController', 3 => 'App\\Controller\\Admin\\MemberCrudController', 4 => 'App\\Controller\\Admin\\NewsCrudController', 5 => 'App\\Controller\\Admin\\PageCrudController', 6 => 'App\\Controller\\Admin\\UserCrudController']);
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('t--wDTGUZO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2pGq+1Qb+W', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('61tikgSCyE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Hi3HL7iByZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('c42rj1dQD5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.user.provider.concrete.your_db_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_YourDbProviderService'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'app.path.member_attachments' => '/uploads/team',
            'app.path.event_attachments' => '/uploads/events',
            ...
            'vich_uploader.mappings' => [
                'member_attachments' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/uploads/team'),
                    'namer' => [
                        'service' => NULL,
                        'options' => NULL,
                    ],
